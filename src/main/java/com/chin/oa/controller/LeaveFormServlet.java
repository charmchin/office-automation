...
import com.chin.oa.service.LeaveFormService;
...
public class LeaveFormServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        response.setContentType("application/json;charset=utf-8");//放在入口位置，一劳永逸
        //http://localhost/api/leave/create
        String uri = request.getRequestURI();
        String methodName = uri.substring(uri.lastIndexOf("/")+1);//加一的原因是不获取/，只获取后面的单词
